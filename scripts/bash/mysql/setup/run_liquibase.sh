...
# Optional changelog override (backward compatible): if no argument is
# supplied, behavior is 100% identical to before - defaults to the table
# changelog exactly as today.
