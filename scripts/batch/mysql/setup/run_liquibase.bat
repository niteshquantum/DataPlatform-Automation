...
REM Optional changelog override (backward compatible): if no argument is
REM supplied, behavior is 100%% identical to before - defaults to the
REM table changelog exactly as today.
set "CHANGELOG=%~1"
