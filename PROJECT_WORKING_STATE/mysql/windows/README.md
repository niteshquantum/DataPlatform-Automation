# PROJECT_WORKING_STATE — MySQL Windows
...
`PROJECT_WORKING_STATE/mysql/windows` should normally be committed to the corresponding development branch so context survives restarts, context loss, and handoffs.
