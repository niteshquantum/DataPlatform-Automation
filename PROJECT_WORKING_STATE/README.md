...
This directory preserves the complete working state of the MongoDB Windows implementation so that any future GPT/Kilo/Antigravity session can recover context without relying on chat history.
